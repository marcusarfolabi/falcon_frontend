        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2.5 bg-slate-900 rounded-xl hover:text-white hover:bg-blue-600 transition-all"
              >
          ...
          <div className="bg-slate-900/40 p-6 rounded-4xl border border-slate-800/50 backdrop-blur-sm">
            <h4 className="text-white font-bold mb-5 text-xs uppercase tracking-tight">
              Trust & Compliance
            </h4>
